...
describe "uc52_never_commit_event_unless_all_handler_submit" do
  before do
    ...
    config = Tengine::Core::Config::Core.new({
        :tengined => {
          :load_path => File.expand_path('../../../../app/event_dsl/uc52_never_commit_event_unless_all_handler_submit.rb', __FILE__),
        },
      })
  ...
  it "一つsubmitしないハンドラがあるのでackされません" do
    ...
    @kernel.ack_policies["event52_alt1"].should == :after_all_handler_submit
    ...
    mock_headers.stub(:reject).and_return(mock_headers)
